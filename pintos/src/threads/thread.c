               ...
               thread_func *function, void *aux) 
{
  ...
  //allocates spaces for the child structure and assigns default
  //untouched values while adding it to current thread's child list
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  //initializes list of thread's children and semaphores for child creation/waiting
